...
public:
	...
	TDelegate<void(class ABP_Powerbox_C* Powerbox)> K2Node_CreateDelegate_OutputDelegate;            // 0x000C(0x0010)(ZeroConstructor, NoDestructor)
	...
	TArray<class ABP_Powerbox_C*>                 CallFunc_GetAllActorsOfClass_OutActors;            // 0x0240(0x0010)(ReferenceParm)
	class ABP_Powerbox_C*                         K2Node_CustomEvent_Powerbox;                       // 0x0250(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABP_Powerbox_C*                         CallFunc_Array_Get_Item_4;                         // 0x0258(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
public:
	class ABP_Powerbox_C*                         Powerbox_0;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
