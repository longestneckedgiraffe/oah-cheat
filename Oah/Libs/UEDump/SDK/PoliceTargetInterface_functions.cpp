...
void IPoliceTargetInterface_C::TakeDamageInterface(int32 DamageTaken, const struct FVector& Attacker_location, bool ShowDirection_)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("PoliceTargetInterface_C", "TakeDamageInterface");
...
void IPoliceTargetInterface_C::CheckIfDowned_(bool* Downed_)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("PoliceTargetInterface_C", "CheckIfDowned?");
...
void IPoliceTargetInterface_C::HitmarkerInterfaceCall(const struct FLinearColor& Color)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("PoliceTargetInterface_C", "HitmarkerInterfaceCall");
...
void IPoliceTargetInterface_C::AddAmmoInterfaceCall(int32 Amount, bool* DidAddAmmo_)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("PoliceTargetInterface_C", "AddAmmoInterfaceCall");
...
void IPoliceTargetInterface_C::CheckHoldingItemInterfaceCall(class AActor** HoldingItem)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("PoliceTargetInterface_C", "CheckHoldingItemInterfaceCall");
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class FString&                    InteractDescription                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
void IPoliceTargetInterface_C::SetInteractDescriptionInterfaceCall(const class FString& InteractDescription)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("PoliceTargetInterface_C", "SetInteractDescriptionInterfaceCall");
...
void IPoliceTargetInterface_C::SetPoliceAlerted(bool Alerted_)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("PoliceTargetInterface_C", "SetPoliceAlerted");
...
void IPoliceTargetInterface_C::GetHoldingActor(class AActor** HoldingActor)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("PoliceTargetInterface_C", "GetHoldingActor");
...
void IPoliceTargetInterface_C::AddCivDeath()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("PoliceTargetInterface_C", "AddCivDeath");
