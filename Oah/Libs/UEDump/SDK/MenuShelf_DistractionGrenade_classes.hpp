...
// Package: MenuShelf_DistractionGrenade
...
// BlueprintGeneratedClass MenuShelf_DistractionGrenade.MenuShelf_DistractionGrenade_C
// 0x0018 (0x0250 - 0x0238)
class AMenuShelf_DistractionGrenade_C final : public AMenuShelf_base_C
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("MenuShelf_DistractionGrenade_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MenuShelf_DistractionGrenade_C")
	}
	static class AMenuShelf_DistractionGrenade_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AMenuShelf_DistractionGrenade_C>();
	}
};
DUMPER7_ASSERTS_AMenuShelf_DistractionGrenade_C;
