...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04AE7A10;
	constexpr int32 AppendString      = 0x00FDE330;
	constexpr int32 GNames            = 0x04AAB6C0;
	constexpr int32 GWorld            = 0x04C2F3B0;
	constexpr int32 ProcessEvent      = 0x011CE8A0;
