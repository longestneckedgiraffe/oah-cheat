...
// Package: Equipmentshelf_equipment_EMP
...
// BlueprintGeneratedClass Equipmentshelf_equipment_EMP.Equipmentshelf_equipment_EMP_C
// 0x0018 (0x0258 - 0x0240)
class AEquipmentshelf_equipment_EMP_C final : public AEquipmentshelf_equipment_base_C
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Equipmentshelf_equipment_EMP_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Equipmentshelf_equipment_EMP_C")
	}
	static class AEquipmentshelf_equipment_EMP_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AEquipmentshelf_equipment_EMP_C>();
	}
};
DUMPER7_ASSERTS_AEquipmentshelf_equipment_EMP_C;
